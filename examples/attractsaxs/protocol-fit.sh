...
if [ ! -s $topstruc ]; then
 python /home/cschindler/software/attract/tools/saxs/saxs-score-wrapper.py exp-processed.dat $outp-filtered --fit --pdb proteinA.pdb proteinB.pdb $outp-gvm1
...
if [ ! -s $newinp ]; then
 ...
 python /home/cschindler/software/attract/tools/saxs/saxs-score-wrapper.py exp-processed.dat $topstruc-combined --fit --pdb proteinA.pdb proteinB.pdb $topstruc-gvm1
