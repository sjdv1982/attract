...
#TODO: lrmsd+backbone, irmsd, fnat for nucleic acids
#TODO: OPLSX docking in easy interface
...
def generate(m):     
  ...
  ret += 'set -u -e\n'    
  ret += 'trap "kill -- -$BASHPID" ERR EXIT\n'  
...
"""      
      ...
      for mnr in range(p.ensemble_size):
        ...
        partnercode += "python $ATTRACTDIR/../allatom/aareduce.py %s %s %s > /dev/null\n" % (mname1, mname2a, opts)
