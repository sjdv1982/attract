...
c  18 format(a4,'r.pdb')
      ...
      isum5=0
      isum6=0
      if((rg(ianf(i)).eq."  A ").or.(rg(ianf(i)).eq." A  ")
     1.or.(rg(ianf(i)).eq."   A").or.(rg(ianf(i)).eq."A   ")) then
     ...
     1.eq."C3' ".or.ty(j).eq."C4' ") then
      ...
      isum6=0
      write(12,28)
     1 at,m,"BN  ",rg(ianf(i)),i,xsum6,ysum6,zsum6,99,0.0,ima,1.
      m=m+1
      endif
      if(ty(j).eq."N7  ") then 
  ...
  110 continue
      ...
      else if((rg(ianf(i)).eq."  G ").or.(rg(ianf(i)).eq." G  ")
     1.or.(rg(ianf(i)).eq."   G").or.(rg(ianf(i)).eq."G   ")) then
  ...
  112 continue
      ...
      else if((rg(ianf(i)).eq."  C ").or.(rg(ianf(i)).eq." C  ")
     1.or.(rg(ianf(i)).eq."   C").or.(rg(ianf(i)).eq."C   ")) then
  ...
  114 continue
      ...
      else if((rg(ianf(i)).eq."  U ").or.(rg(ianf(i)).eq." U  ")
     1.or.(rg(ianf(i)).eq."   U").or.(rg(ianf(i)).eq."U   ")) then
