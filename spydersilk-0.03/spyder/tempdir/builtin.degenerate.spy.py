...
class Degenerate(Object):
 ...
 file 'degenerate.spy'
  ...
  Base class for degenerate models
...
"""
  ...
  def constructor_fromlist(self, *args, **args2):
    ...
    try:
      ...
      spyder.errorpath[:] = errorpath[:]
      err = str(e)
      exc = "An error has occurred in the construction of a Degenerate object"      
  ...
  def __init__(self,*args, **args2):
    ...
    Degenerate.__dict__[Degenerate.__constructor__](self, *args, **args2)
  ...
  def __getattr__(self, method):
    ...
    m = spyder.core.method(Degenerate, method, self)
    return m
  ...
  def __eq__(self,_a):
    ...
    Comparison operator"""
    try:
      if not isinstance(_a,Degenerate) and not isinstance(self, type(_a)): return False
...
spyder.__types__["Degenerate"] = Degenerate
spyder.core.error["Degenerate"] = {}
if hasattr(Degenerate, '_register_errors'): Degenerate._register_errors()
Degenerate._requiredmembers = []
Degenerate._defaultmembers = []
Degenerate.__form__()
ResourceDegenerate = spyder.__types__["_Resource"](Degenerate)

Degenerate.empty = functools.partial(spyder.__constructor, 
  "constructor_empty",
  Degenerate,
  "constructor_fromany",
)
Degenerate.fromlist = functools.partial(spyder.__constructor, 
  "constructor_fromlist",
  Degenerate,
  "constructor_fromany",
)
Degenerate.fromdict = functools.partial(spyder.__constructor, 
  "constructor_fromdict",
  Degenerate,
  "constructor_fromany",
)

class DegenerateArray(spyder.core.spyderlist):
  @staticmethod
  def typename(): return "DegenerateArray"
  ...
  def __eq__(self,_a):
    """Auto-generated by Spyder:
     ...
     function generate_eq
    Comparison operator"""
    if not isinstance(_a, DegenerateArray) and not isinstance(self, type(_a)): return False
    if _a is self: return True
  ...
  def convert(self, target,deepcopy=True):
    c = spyder.core.convert(DegenerateArray, target, self, deepcopy)
    return c
  def threadconvert(self, target,deepcopy=True):
    c = spyder.core.spyderthread.threadstart (
     spyder.core.convert, (DegenerateArray, target, self,deepcopy),
     name="DegenerateArray=>%s" % target.typename(), 
    )
    return c    

  def __getattr__(self, method):    
      m = spyder.core.method(DegenerateArray, method, self)
      return m
  ...
  def list(self):
    ...
    for vnr in range(len(self)):
      if type(self[vnr]) != Degenerate: self[vnr] = Degenerate(self[vnr])
  ...
  def __arrayvalidate__(self):
    if self.__constructor__ == self.__defaultconstructor__:
      def reconstruct(classtype, index, var):
        spyder.errorpath.append((DegenerateArray, classtype,index))
        ret = classtype(var)
    ...
    for v in range(len(self)):
      self[v] = reconstruct(Degenerate,v,self[v])
  ...
  def constructor_fromlist(self, *a):
    ...
    try:
      ...
      spyder.errorpath[:] = errorpath[:]      
      err = str(e)
      exc = "An error has occurred in the construction of a DegenerateArray object"      
      if isinstance(e, spyder.ConstructionError):
        raise spyder.ConstructionError(spyder.exception(exc + "\n" + err))
      else:
        raise spyder.ConstructionError(exc + spyder.exception())      
  ...
  def __init__(self,*a, **args2):
    ...
    DegenerateArray.__dict__[DegenerateArray.__constructor__](self, *a)  
  def constructor_fromany(self, *a):
    ...
    try:  
      try:
        ...
        if issubclass(Spyder.Degenerate, Spyder.StringLike):
          try:
...
spyder.core.defineconverter("DegenerateArray","Degenerate","SPLIT")
spyder.core.defineconverter("Degenerate","DegenerateArray","CAST")
spyder.__types__["DegenerateArray"] = globals()["DegenerateArray"]  
arrayclass = spyder.__types__["DegenerateArray"]
spyder.__types__["ResourceDegenerateArray"] = spyder.__types__["_Resource"](arrayclass)
...
arrayclass.__form__()
class DegenerateArrayArray(spyder.core.spyderlist):
  @staticmethod
  def typename(): return "DegenerateArrayArray"
  def __spydercopy__(self,a):
    list.__init__(self, a)
    if hasattr(a, "__conversionstack__"): self.__conversionstack__ = a.__conversionstack__
  ...
  def __eq__(self,_a):
    """Auto-generated by Spyder:
     ...
     function generate_eq
    Comparison operator"""
    if not isinstance(_a, DegenerateArrayArray) and not isinstance(self, type(_a)): return False
    if _a is self: return True
    if len(self) != len(_a): return False
    for n,nn in zip(self,_a):
      if n != nn: return False
  ...
  def convert(self, target,deepcopy=True):
    c = spyder.core.convert(DegenerateArrayArray, target, self, deepcopy)
    return c
  def threadconvert(self, target,deepcopy=True):
    c = spyder.core.spyderthread.threadstart (
     spyder.core.convert, (DegenerateArrayArray, target, self,deepcopy),
     name="DegenerateArrayArray=>%s" % target.typename(), 
    )
    return c    

  def __getattr__(self, method):    
      m = spyder.core.method(DegenerateArrayArray, method, self)
      return m
  ...
  def __arrayvalidate__(self):
    if self.__constructor__ == self.__defaultconstructor__:
      def reconstruct(classtype, index, var):
        spyder.errorpath.append((DegenerateArrayArray, classtype,index))
        ret = classtype(var)
        spyder.errorpath.pop()
        return ret
    else:
       def reconstruct(classtype, index, var):         
         ...
         return ret               
    for v in range(len(self)):
      self[v] = reconstruct(DegenerateArray,v,self[v])
  def __validate__(self):
    try:
      self.__arrayvalidate__()
    except AssertionError as exc:
  ...
  def constructor_fromlist(self, *a):
    ...
    try:
      ...
      spyder.errorpath[:] = errorpath[:]      
      err = str(e)
      exc = "An error has occurred in the construction of a DegenerateArrayArray object"      
      if isinstance(e, spyder.ConstructionError):
        raise spyder.ConstructionError(spyder.exception(exc + "\n" + err))
      else:
        raise spyder.ConstructionError(exc + spyder.exception())      
  ...
  def __init__(self,*a, **args2):
    ...
    Init function, calls the general constructor (fromany by default)"""
    if len(args2.keys()): raise Exception          
    DegenerateArrayArray.__dict__[DegenerateArrayArray.__constructor__](self, *a)  
  def constructor_fromany(self, *a):
    """Auto-generated by Spyder:
     module core
     file init.py
    ...
    try:  
      try:
        if len(a) > 1: raise Exception
        if issubclass(Spyder.DegenerateArray, Spyder.StringLike):
          try:
            args = spyder.core.parse(a[0], "Spyder")
            if not isinstance(args, str): raise Exception
            self.__spydercopy__([args])            
...
spyder.core.defineconverter("DegenerateArrayArray","DegenerateArray","SPLIT")
spyder.core.defineconverter("DegenerateArray","DegenerateArrayArray","CAST")
spyder.__types__["DegenerateArrayArray"] = globals()["DegenerateArrayArray"]  
arrayclass = spyder.__types__["DegenerateArrayArray"]
spyder.__types__["ResourceDegenerateArrayArray"] = spyder.__types__["_Resource"](arrayclass)
arrayclass.empty = functools.partial(spyder.__constructor, 
"constructor_empty",
arrayclass,
"constructor_fromany",
